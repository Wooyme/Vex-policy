"""Robot configuration types for vex_policy."""
...
class RobotConfig:
    ...
    robot_type: str
    """Robot identifier (for example ``g1_29dof``)."""
    ...
    The built-in backend is ``unitree``; extensions may register other values.
    ...
    """Optional parallel-mechanism joint names for extension backends."""
